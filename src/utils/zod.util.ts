...
export const ZodNameString = z
  ...
  .regex(
    CommonConstant.NAME_STRING,
    "Only Bengali or English characters, number, space are allowed"
  );
...
export const ZodNumericNonNegString = z
  ...
  .regex(
    new RegExp(CommonConstant.STRING_NUM_PATTERN_NON_NEG),
...
export const ZodMin1UpdateRefine = (data: NonNullable<unknown>) => {
  const isAllUndefinedOrNull = Object.values(data).every(
